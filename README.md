...
Click [Photofolio](https://github.com/MutuaFranklin/Photofolio) to navigate on the main page of the project repository on Github.
...
```
Type https://github.com/MutuaFranklin/Photofolio and press Enter to create your local clone.
